...
module.exports = {
  ...
  mode: process.env.NODE_ENV || "production", //prod mode if not manually set (webpack optimization in prod)
  resolve: {
    ...
    rules: [
      {
        ...
        use: {
          loader: "babel-loader",
          options: {
            presets: ["@babel/preset-env", "@babel/preset-react"] //Babel to convert ES6 to ES5
          }
        }
      },
      {
